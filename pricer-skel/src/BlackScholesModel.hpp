...
class BlackScholesModel
{
  public:
     ...
     */
    void asset(PnlMat* path, double T, int nbTimeSteps, PnlRng* rng) const;
    ...
    void stepSimulation(PnlVect* current_spot, double dt, PnlRng* rng) const;
