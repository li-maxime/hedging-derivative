...
class MonteCarlo
{
  public:
    ...
    int nbHedgingDates_;
    PnlVect* computeHelper;

    MonteCarlo(BlackScholesModel* mod, Option* opt, PnlRng* rng, double fdStep, long nbSamples,int nbHedgingDates_);
    ~MonteCarlo();
    /**
    ...
    void deltaComputeValue(PnlVect* delta, PnlVect* std_dev, PnlVect* spot_t, double t);

    void deltaComputeSum(PnlVect* delta, PnlVect* std_dev, PnlMat* path, PnlMat* shift_path, double t);
};
